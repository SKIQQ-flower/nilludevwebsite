<template>
    <div
        class="h-dvh absolute w-dvw flex flex-col items-center justify-center shadow-pink-500 shadow-md transition-all">
        <img class="md:top-[35%] md:left-[30%] top-[10%] fixed md:rotate-[45deg] md:w-[50rem] w-52 -z-10"
            src="/yotsuba.png">
        <div
